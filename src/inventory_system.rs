...
impl<'a> System<'a> for ItemUseSystem {
    ...
    fn run(&mut self, data: Self::SystemData) {
        ...
        for (entity, useitem) in (&entities, &wants_use).join() {
            ...
            //    None => {}
            //    Some(_) => {
            //        entities.delete(useitem).expect("Delete failed");
            //    }
            //}
            ...
            match item_equippable {
                ...
                Some(can_equip) => {
                    ...
                    // remove items the target has in the item's slot
            ...
            // should it inflict damage, apply it to the targeted cell
